export const NFTProgramId = 'OviNFT.aleo';

export const NFTProgram = `program OviNFT.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller alaleo1nxm5ynptccuyqgkt65p3xsccw0qvqgkmtvd3q2qtasj0wexa0qzq80e5l2;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as OviNFT.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as OviNFT.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as OviNFT.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as OviNFT.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as OviNFT.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as OviNFT.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as OviNFT.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as OviNFT.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as OviNFT.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as OviNFT.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as OviNFT.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as OviNFT.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as OviNFT.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as OviNFT.aleo/convert_public_to_private.future;
